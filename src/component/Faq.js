...
function Faq() {
    ...
    <div class="accordion" id="faq-list">
      <ul class="list-unstyled">
        <li class="py-1">
          <a data-toggle="collapse" class="text-muted display" href="#faq1" aria-expanded="true" style={{fontSize: '2.5vh'}}><IoIosArrowForward color="#4f70ce" size=".7rem"/><b>Is Discover A Social Media Platform ?</b>
          </a>
        ...
        <li class="py-1">
          <a data-toggle="collapse" href="#faq2" class="text-decoration-none text-muted" style={{fontSize: '2.5vh'}} aria-expanded="true"><IoIosArrowForward color="#4f70ce" size=".7rem"/> <b>Is the information shared on Discover kept private and confidential?</b>
          </a>
...
text format. PII data always remains in a one-way-hash format.
        ...
        <li class="py-1">
          ...
          <div id="faq3" class="multi-collapse collapse" data-parent="#faq-list">
            <p class="lead">
											a. Every recruiter tracks candidate’s commitment independently, Discover is a way to collaborate on this tracking anonymously, so that it benefits everyone including candidates to make decisions with clarity.
                      b. Glassdoor collates data from employees and ex-employees on salaries, culture etc. on the companies they work(ed) with. Discover works on the other side.
										 </p>
          </div>
        </li>
      </ul>
