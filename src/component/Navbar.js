        ...
        <div class="container" style={{ color: "black" }}>
          ...
          <div class="collapse navbar-collapse" id="navbar4">
            <ul class="navbar-nav ml-auto order-md-11">
              ...
              {/* <li class="nav-item" style={{cursor:'pointer'}}><Link activeClass="active" className="nav-link" to="Services" spy={true} smooth={true} duration={500} >SERVICES</Link> </li>
              <li class="nav-item" style={{cursor:'pointer'}}><Link activeClass="active" className="nav-link" to="Faq" spy={true} smooth={true} duration={500} >FAQ</Link> </li>
              <li class="nav-item" style={{cursor:'pointer'}}><Link activeClass="active" className="nav-link" to="Contact" spy={true} smooth={true} duration={500} >CONTACT</Link> </li> */}
            </ul>
          </div>
        </div>
      </nav>
